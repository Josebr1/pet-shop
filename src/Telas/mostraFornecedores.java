 ...
 * @author Juliano
 */
public class mostraFornecedores extends javax.swing.JInternalFrame {

    private FornecedorDAO fd = new FornecedorDAO();

    public mostraFornecedores() {
        initComponents();
        carregarGrade();
    }
