...
import Models.ItemVendaTableModel;
...
public class LancamentoVenda extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/buscar.png"))); // NOI18N
    ...
    private void tbGradeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGradeMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            ftfCliente.setText(venda.getCliente().getNome());
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        int opcao = JOptionPane.showConfirmDialog(this, "Deseja realmente cancelar a venda " + venda.getCodigo() + "?");
        if (opcao == 0) {
            try {
