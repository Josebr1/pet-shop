...
public class ProdutoDAO{
    ...
    public void inserir(Produto produto) throws Exception {
        ...
        ps.setFloat(2, produto.getPrecoCompra());
        ps.setFloat(3, produto.getPrecoVenda());
        ps.execute();
        c.confirmar();
    }
    ...
    public void entradaEstoque(Conecta c, int codigo, int quantidade) throws Exception {
    ...
    public void saidaEstoque(Conecta c, int codigo, int quantidade) throws Exception {
        String sql = "UPDATE TBPRODUTO SET QUANTIDADEESTOQUE= QUANTIDADEESTOQUE  - ? WHERE CODIGO=?";
        PreparedStatement ps = c.getConexao().prepareStatement(sql);
        ps.setInt(1, quantidade);
        ps.setInt(2, codigo);
